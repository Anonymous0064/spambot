...
async def start_rizoel():
    ...
    if baish:
        ...
        try:
            ...
            await non(functions.channels.JoinChannelRequest(channel="@DragNeelOP"))
            await non(functions.channels.JoinChannelRequest(channel="@DNHxHELL"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
    ...
    if teish:
        ...
        try:
            ...
            await rooted(functions.channels.JoinChannelRequest(channel="@DragNeelOP"))
            await rooted(functions.channels.JoinChannelRequest(channel="@DNHxHELL"))
            botid = telethon.utils.get_peer_id(botme)
            SMEX_USERS.append(botid)
        except Exception as e:
            print(e)
